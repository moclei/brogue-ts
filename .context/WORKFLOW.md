...
**Guidelines:**
- Tasks should be concrete and actionable. "Set up PostgreSQL and create schema" not "figure out data storage."
- Brief inline notes on completed tasks are fine when they add useful context (e.g., `- [x] Set up Whisper — went with faster-whisper for 4x speed improvement`). Not required, just allowed.
