/*
 *  effects.ts — Visual effects: flashes, fades
 *  Port V2 — rogue-ts
 *
...
import type { Color, Pos, Creature, ScreenDisplayBuffer } from "../types/types.js";
...
import { black, white } from "../globals/colors.js";
