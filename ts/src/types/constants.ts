...
export const CHARM_EFFECT_DURATION_INCREMENT_ARRAY_SIZE = 50;
export const NUMBER_WEAPON_RUNIC_KINDS = 10;
export const NUMBER_GOOD_WEAPON_ENCHANT_KINDS = 7; // W_MERCY
